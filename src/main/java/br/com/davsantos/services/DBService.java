...
public class DBService {
	...
	public void instantiateHmlDataBase() throws ParseException {
		...
		Produto p8 = new Produto(null, "Roçadeira", 600.00);
		Produto p9 = new Produto(null, "Abajour", 100.00);
		Produto p10 = new Produto(null, "Forro", 180.00);
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "david.evangelista.dev@gmail.com", "36398755100", TipoCliente.PESSOA_FISICA);
